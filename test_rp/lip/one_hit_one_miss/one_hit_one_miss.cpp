...
// kernel code
// Access pattern: a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, b
// Access count: 19
...
__global__ void kernel(int * arr) {
  ...
  uint64_t a = 0, b = 0, c = 0, d = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0;
  asm volatile(
	       /*
	       ...
	       */
	       ...
	       "buffer_wbinvl1\n\t"
               ...
               : [out0]"=v"(a), [out2]"=v"(b), [out4]"=v"(c), [out6]"=v"(d), [out8]"=v"(e), [out10]"=v"(f), [out12]"=v"(g), [out14]"=v"(h), [out16]"=v"(i), [out18]"=v"(j),
                 [out20]"=v"(k), [out22]"=v"(l), [out24]"=v"(m), [out26]"=v"(n), [out28]"=v"(o), [out30]"=v"(p), [out32]"=v"(q), [out34]"=v"(r)
...
[in29]"v"((uint64_t *)&arr[917504]), [in31]"v"((uint64_t *)&arr[983040]), [in33]"v"((uint64_t *)&arr[1048576]), [in35]"v"((uint64_t *)&arr[983041])
               :"memory"
               );
}
